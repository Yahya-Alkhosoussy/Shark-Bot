    ...
    ROLES_PER_GUILD: dict[int, dict[str, dict[discord.PartialEmoji, int]]] = {
        ...
        gids["shark squad"]: {
            ...
            "backpack": {
                ...
                discord.PartialEmoji(name="animateduwu", animated=True, id=1279478093278609491): roles["backpacks and sherpas"][
                    "DNA backpack"
                ],
                discord.PartialEmoji(name="Zerotwosurprisedbyliliiet112", id=1318361087833538631): roles[
                    "backpacks and sherpas"
                ]["ZZZ backpack"],
            },
            "sherpa": {
